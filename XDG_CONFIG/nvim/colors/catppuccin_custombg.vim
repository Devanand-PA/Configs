...
call s:hi("DiffAdd", "NONE", s:green, s:teal, "NONE", "NONE")
call s:hi("DiffChange", "NONE", s:yellow, s:yellow, "NONE", "NONE")
call s:hi("DiffDelete", "NONE", s:red, s:red, "NONE", "NONE")
